...
\todo[inline]{elaborate on this \dots testing the automaton construction means running some strings on the automaton...}
...
On the \code{--val} flag, the Model Checker should construct the FSA starting from \textbf{negation of} 
